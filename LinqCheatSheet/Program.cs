...
// Challenge 1 - Order Lawyers by money in dispute for commercial cases only
var challenge1 = lawyers.OrderBy(l => l.Cases.Where(c => c.CaseType == CaseType.Commercial).Sum(c => c.AmountInDispute));

// Challenge 2 - Select all cases from Clients as an IEnumerable<List<Case>>
var challenge2 = clients.Select(c => c.Cases);

// Challenge 3 - Select all cases from Clients as a flattened list
var challenge3 = clients.SelectMany(c => c.Cases);

// Challenge 4 - Select a list of strings containing the following fields comma separated
